...
<section class="dash-card">
    ...
    <div>
        <form method="POST">
        <div class="col-12 form-separator">
            <input class="col-1 prof-input-text" type="text" name="titulacao" placeholder="Titulação" />
            <input class="col-9 prof-input-text" type="text" name="nome" placeholder="Nome" />
        </div>        
        <div class="col-12 form-separator">
            <input class="col-4 prof-input-text" type="tel" name="tel" placeholder="tel" />
            <input class="col-6 prof-input-text" type="email" name="email" placeholder="email" />
        </div>
        <div class="col-12 form-separator">
            <input class="col-4 prof-input-text" type="text" name="lattes" placeholder="Link Lattes" />
            <input class="col-6 prof-input-text" type="text" name="facebook" placeholder="Facebook" />
        </div>
        <div class="col-12 form-separator">
