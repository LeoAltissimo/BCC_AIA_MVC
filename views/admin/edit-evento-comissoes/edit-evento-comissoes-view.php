...
<section class="dash-card">
    ...
    <div>
        ...
        <input type="hidden" name="comissaoId" value="<?php echo $parametros[1] ?>">
        <div class="col-12">
            <input class="col-12 prof-input-text" type="text" name="rotulo" placeholder="Título da comissão" value="<?php echo $vals["comissaoRotulo"] ?>" />
            ...
            <div>
                <div class='editContainer'>
                    ...
                    <?php echo $vals["comissaoIntegrantes"] ?>
                    </div>
